...
$logger->log('info', 'infos', "Entrée dans AfficherTerrain.php", Logger::GRAN_MONTH);
...
$terrain = $manager->trouverTerrain($idClub, $libelle);

// mise en session du terrain
$_SESSION['terrain'] = $terrain;
header("Location: ajouterTerrain.php?idClub=$idClub");
?>