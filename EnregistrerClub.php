...
$logger->log('info', 'infos', "Entrée dans EnregistrerClub.php", Logger::GRAN_MONTH);
...
try {
	...
	if ($mode == 'creation') {
		$manager->ajouterClub($nom, $numAffiliation, $ligue, $district, /*$logo*/-1, $siteWeb, $adresse,
			$adresse2, $adresse3, $codePostal, $ville, $pays, $email1, $email2,
			$tel1, $tel2, $fax1, $fax2, $stade, $couleur1, $couleur2);
	} else {
		$id = $_POST[id];
		$manager->mettreAJourClub($id, $nom, $numAffiliation, $ligue, $district, /*$logo*/-1, $siteWeb, $adresse,
			$adresse2, $adresse3, $codePostal, $ville, $pays, $email1, $email2,
			$tel1, $tel2, $fax1, $fax2, $stade, $couleur1, $couleur2);
	}
	...
	$messageErreur = "Erreur lors de la création/modification du club.";
