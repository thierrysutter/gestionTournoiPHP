...
$logger->log('info', 'infos', "Entrée dans AfficherListeTournois.php", Logger::GRAN_MONTH);
...
$listeTournois = $manager->trouverTournois(0);

// mise en session de la liste des membres
$_SESSION['listeTournois'] = $listeTournois;
